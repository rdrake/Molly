...
\usepackage[acronym,style=tree,sanitize={name=false,description=false,symbol=false}]{glossaries}
...
% Include only items we're currently working on to speed up compilation
%\includeonly{along-came-clojure}
