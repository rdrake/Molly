...
\label{sec:basic-principles-fp}
	...
	\label{sec:features-of-clojure}
		...
		\subsubsection{Concurrency}
			\todo{Introduce transactions}
			\todo{Explain, with examples, the difference between coordinated and uncoordinated}
			...
			\gls{stm} provides more control than atoms.  In addition to updates being atomic, they are also guaranteed to be consistent and isolated.  \gls{stm} also supports constraints on transactions.
