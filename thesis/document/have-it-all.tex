...
\label{chap:best-of-both-worlds}
	...
	\section{Iterative Search Using Document Encodings}
		...
		\begin{ex}[Entity Graph Search]
			...
			The entity graph is shown in \cref{fig:path-initial}.
			...
			There are two possible paths between ``subject|math'' and ``instructor|5''.  The path in \cref{fig:path-2} is shorter than that in \cref{fig:path-1}, meaning it is likely the most relevant.
