...
% Chapter 2 is a bit more background than anything
% Move chapter 1 to under chapter 2, make chapter 2 chapter 1.
...
% Consider putting web interface at end of (current) chapter 4
