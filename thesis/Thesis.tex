...
\newmintedfile[cljcode]{clj}{linenos,frame=topline,frame=lines,framesep=2mm,mathescape}
...
\begin{document}
	\thesistitle{Molly}{Richard J.I. Drake}{Master of Science (MSc)}{Science}{Computer Science}{Dr. Ken Q. Pu}{August}{2013}
...
%	\end{acknowledgements}
	...
	\chapter{RDBMS to Document Store}
		...
		\begin{figure}[ht!]
			...
			\caption{conf/mycampus.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/datatypes/database.clj}
			
			\caption{datatypes/database.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/datatypes/entity.clj}
						
			\caption{datatypes/entity.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/datatypes/index.clj}
			
			\caption{datatypes/index.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/datatypes/schema.clj}
			
			\caption{datatypes/schema.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/index/build.clj}
			
			\caption{index/build.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/util/nlp.clj}
			
			\caption{util/nlp.clj}
		\end{figure}
	...
	\chapter{Search}
		\begin{figure}[ht!]
			...
			\caption{search/lucene.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/search/query_builder.clj}
			
			\caption{search/query\_builder.clj}
		\end{figure}
		
		\begin{figure}[ht!]
			\cljcode{../src/molly/server/serve.clj}
			
			\caption{server/serve.clj}
		\end{figure}
